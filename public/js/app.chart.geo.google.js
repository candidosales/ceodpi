	...
	function drawMap() {
	  ...
	  data.addRows([
		[arrayMapa[0].estado, parseInt(arrayMapa[0].tipo1), parseInt(arrayMapa[0].tipo2)],
		/*[arrayMapa[1].estado, parseInt(arrayMapa[1].tipo1), parseInt(arrayMapa[1].tipo2)],
		[arrayMapa[2].estado, parseInt(arrayMapa[2].tipo1), parseInt(arrayMapa[2].tipo2)],
		[arrayMapa[3].estado, parseInt(arrayMapa[3].tipo1), parseInt(arrayMapa[3].tipo2)],
