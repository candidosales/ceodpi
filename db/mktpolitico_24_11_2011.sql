...
# Dumping data for table marketingpolit.cliente: ~51 rows (approximately)
...
# Dumping data for table marketingpolit.transacao_moip: ~195 rows (approximately)
