        ...
        if (count($this->_filters) > 0) {
            ...
            if ($this->getParam('order') && !$this->getParam('noOrder') && count($this->_filtersValues) > 0) {
                if ($this->getInfo("ajax") !== false) {
                    $final1 = "<button class='button' href=\"gridAjax('{$this->getInfo("ajax")}','"
                            . $url . "')\">" . $this->__('Remove Filters') . "</button>"
                            . "<button class='button' onclick=\"gridAjax('{$this->getInfo("ajax")}','"
                            . $url2 . "')\">" . $this->__('Remover Ordem') . "</button>"
                            . "<button class='button' onclick=\"gridAjax('{$this->_info['ajax']}','"
                            . $url3 . "')\">" . $this->__('Remover Busca e Ordem') . "</button>";
                } else {
                    $final1 = "<button class='button' onclick=\"window.location='$url'\">"
                            . $this->__('Remover Filtros') . "</button><button onclick=\"window.location='$url2'\">"
                            . $this->__('Remover Ordem') . "</button><button onclick=\"window.location='$url3'\">"
                            . $this->__('Remover Filtros e Ordem') . "</button>";
                }
                //Only filters
                ...
                if ($this->getInfo("ajax") !== false) {
                    ...
                    $final1 = "<button class='button' onclick=\"window.location='$url'\">" . $this->__('Remover Buscar') . "</button>";
                }
                ...
                if ($this->getInfo("ajax") !== false) {
                    ...
                    $final1 = "<button class='button' onclick=\"window.location='$url2'\">" . $this->__('Remover Ordem') . "</button>";
                }
            }
            ...
            if (($this->getInfo('noFilters') != 1 || $this->_allowAdd == 1)
                ...
                if (strlen($final1) > 5 || $this->getUseKeyEventsOnFilters() == false) {
                    if ($this->getUseKeyEventsOnFilters() === false && $this->getInfo('noFilters') != 1) {
                        $final1 .= "<button class='button' onclick=\"_" . $this->getGridId() . "gridChangeFilters(1)\"><span class='search'>"
                                 . $this->__('Buscar') . "</span></button>";
                    }
